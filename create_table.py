...
conn.execute('create table if not exists Users(username TEXT, address TEXT, email TEXT, pincode TEXT, password TEXT, Telephone TEXT,current balance TEXT )')
conn.execute('create table if not exists Restaurant(restaurantName TEXT, address TEXT, email TEXT, zipcode TEXT, Telephone TEXT, password TEXT)')
